 ...
 */
final class Version20211023103858 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE artwork (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, title VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, image VARCHAR(255) NOT NULL, validated DATETIME DEFAULT NULL, INDEX IDX_881FC576A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE author (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, validated DATETIME DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE media_artwork (media_id INT NOT NULL, artwork_id INT NOT NULL, INDEX IDX_E9C8433FEA9FDD75 (media_id), INDEX IDX_E9C8433FDB8FFA4 (artwork_id), PRIMARY KEY(media_id, artwork_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE media_artwork ADD CONSTRAINT FK_E9C8433FEA9FDD75 FOREIGN KEY (media_id) REFERENCES media (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE media_artwork ADD CONSTRAINT FK_E9C8433FDB8FFA4 FOREIGN KEY (artwork_id) REFERENCES artwork (id) ON DELETE CASCADE');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE media_artwork DROP FOREIGN KEY FK_E9C8433FDB8FFA4');
        $this->addSql('ALTER TABLE author_artwork DROP FOREIGN KEY FK_CD255A35F675F31B');
        $this->addSql('ALTER TABLE media_artwork DROP FOREIGN KEY FK_E9C8433FEA9FDD75');
        ...
        $this->addSql('DROP TABLE media_artwork');
